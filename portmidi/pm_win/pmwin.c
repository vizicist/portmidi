 ...
 */
 ...
 /* NOTE: in order to be compilable in both UNICODE and non-UNICODE
    mode, we forcibly use the ANSI versions of all the Windows
    functions (like RegOpenKeyExA and RegQueryValueExA).
 */
...
#define PATTERN_MAX 256
    ...
    if (RegQueryValueExA(hkey, key, NULL, &dwType, pattern, &pattern_max) != 
	ERROR_SUCCESS) {
        return id;
    }
